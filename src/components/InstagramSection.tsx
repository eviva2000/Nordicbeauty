  ...
  return (
    <section className=" py-16 bg-[#f3f4f1] text-[#2f4f4f]">
      <div className="container mx-auto px-4 flex flex-col gap-8 items-center justify-center">
        <h2 className="text-3xl font-bold text-center">ما را در اینستاگرام دنبال کنید</h2>
        <p className="text-lg max-w-2xl">
          ...
          قرار دارد. ما تلاش می‌کنیم همواره تازه‌ترین و کامل‌ترین جزئیات را در اختیار شما بگذاریم تا
          انتخابی آگاهانه و مطمئن داشته باشید
        </p>
        <a
          ...
          className=""
        >
          <SiInstagram className="w-16 xl:w-20 h-16 xl:h-20 text-[#2f4f4f] mx-auto" />
        </a>
      </div>
    </section>
  );
