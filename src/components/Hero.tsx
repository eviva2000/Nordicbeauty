    ...
    <section className="relative w-screen h-screen">
      ...
      <div className="main-content flex flex-col-reverse sm:flex-row px-6 justify-center items-center ">
        ...
        <div className=" relative  xl:max-w-[800px] lg:px-20">
          ...
          <Link className="flex justify-end" href="https://www.instagram.com/zibanordic/">
            <div className="border border-inherit border-solid p-4 rounded-full  mx-auto sm:mx-0 w-3xs  flex items-center justify-center sm:justify-end text-[#2f4f4f]">
              ما را در اینستاگرام دنبال کنید
              <Image
                className="instagram-logo"
                alt=""
                src="/New Project (1).svg"
                width={50}
                height={50}
              />
            </div>{" "}
